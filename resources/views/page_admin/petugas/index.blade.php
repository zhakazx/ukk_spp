      ...
      <div class="card border shadow-xs mb-4">
        <div class="card-header border-bottom pb-0">
          <div class="d-sm-flex align-items-center mb-3">
            <div>
              <h6 class="font-weight-semibold text-lg mb-0">Data Petugas</h6>
            ...
            <div class="ms-auto d-flex">
              ...
              <a href="{{ route('petugas.create') }}" class="btn btn-sm btn-dark btn-icon d-flex align-items-center mb-0 me-2">
              ...
              <tbody>
                @forelse ($petugas as $item)
                  <tr>
                    ...
                    <td>
                      <span class="text-sm font-weight-normal">{{ $item->nama_petugas }}</span>
                    </td>
                    <td>
                      <span class="text-sm font-weight-normal">{{ $item->username }}</span>
                    </td>
                    <td>
                      <span class="text-sm font-weight-normal">{{ $item->level }}</span>
                    </td>
                    <td class="align-middle">
                      <a href="{{ route('petugas.edit', $item->id) }}" class="text-secondary font-weight-bold text-xs" data-bs-toggle="tooltip" data-bs-title="Edit">
        ...
        <div class="card-footer">
          <div class="py-3 px-3 d-flex justify-content-center justify-content-md-between justify-content-lg-between align-items-center">
            {{ $petugas->links('layouts.pagination') }}
          </div>
        </div>
      </div>
    </div>
