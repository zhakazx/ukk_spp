      ...
      <div class="card border shadow-xs mb-4">
        <div class="card-header border-bottom pb-0">
          <div class="d-sm-flex align-items-center mb-3">
            <div>
              <h6 class="font-weight-semibold text-lg mb-0">Tunggakan</h6>
            ...
            <table class="table table-bordered align-items-center justify-content-center mb-0" id="datatable" width="100%">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <a href="{{ route('cetak.kwitansi.tunggakan', $item->id) }}" target="_blank" class="btn btn-sm btn-success d-sm-block d-none mb-0">
